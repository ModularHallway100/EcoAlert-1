...
function PlatformExampleContent() {
  ...
  const { theme, toggleTheme, config: themeConfig } = usePlatformTheme();
  const { settings, updateSetting, announceSuccess, announceError } = useAccessibility();
          ...
          header={{
            ...
            actions: (
              <div className="flex items-center space-x-2">
                ...
                />
                <FontSizeControls
                  currentSize={settings.fontSize === 'medium' ? 'medium' : 'small'}
              ...
              <ResponsiveGrid cols={{ default: 1, md: 2, lg: 3 }} gap="lg">
                <PlatformCard elevation="md" className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <ResponsiveText size="sm" className="text-gray-600 dark:text-gray-400">
                      Font Size: <span className="font-medium">{settings.fontSize === 'medium' ? 'Medium' : 'Small'}</span>
                    </ResponsiveText>
                  </div>
                </PlatformCard>
                ...
                <PlatformCard elevation="md" className="p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      >
                        {settings.animations ? 'Disable' : 'Enable'} Animations
                      </PlatformButton>
                    </div>
                    <div>
                      <ResponsiveText size="sm" className="text-gray-600 dark:text-gray-400 mb-2">
...
export default function PlatformExampleWrapper() {
